          ...
          <div className="col-5">
            <div className="h-100 d-flex flex-column justify-content-between align-items-start">
              <div>
                ...
                <div className="text mb-3 mb-xxl-4 text-break">{props.text}</div>
              </div>
          ...
          <div className="col-3">
            ...
            <div className="author w-fit d-flex flex-column align-items-center ms-auto mt-4">
              ...
              {props.user?.createdAtForUser && (
                <div className="gray-3 fs-08 mt-2">
                  На сайте с {props.user?.createdAtForUser}
                </div>
              )}
          ...
          <div className="p-3">
            <div className="d-flex flex-column justify-content-between mb-2 gap-1">
              <div className="title color-1 title-font fw-7 fs-11">
                {props?.realEstateTypeForUser
                  ...
                  <>
                    {props?.estateName} {props?.title} м<sup>2</sup>
                  </>
                )}
              </div>
            ...
            <div className="rating mb-3">
              <Rating
                ...
                stop="5"
                readonly={true}
                initialRating={props?.user?.rating}
                fractions={2}
