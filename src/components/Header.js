...
const Header = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        const isInValidName =
            data?.name === undefined || data.name?.length < 1 || data.name?.length > 55;
                ...
                <nav className="d-flex justify-content-center">
                    <ul className="offcanvas-menu__list">
                        <li>
                            ...
                            >
                                <img src={MainPageIcon} alt="Главная" />
                                Главная
                            </NavLink>
                        </li>
                        <li>
                        ...
                        <li>
                            <NavLink
                                ...
                                className={`${
                                    pathname === "/personal-account/favorites"
                                        ? "active"
                                        : ""
                                } d-flex p-2 justify-content-start align-items-center gap-2`}
                                onClick={() => {
                        ...
                        <li>
                            ...
                            >
                                <img src={HypotecIcon} alt="Ипотека" />
                                Ипотека
                            </NavLink>
                        </li>
                        <li>
                            ...
                            >
                                <img src={ArticlesIcon} alt="Статьи" />
                                Статьи
                            </NavLink>
                        </li>
                    </ul>
                    ...
                    <form className="message-form">
                        ...
                        <div className="row align-items-center fs-11 mt-3">
                            ...
                            <div className="col-sm-9 mb-sm-3">
                                <input
                                    style={{
                                        borderColor: valid.isInValidQuestions
                                            ? "#DA1E2A"
                                            : ""
                                    }}
                                    type="text"
