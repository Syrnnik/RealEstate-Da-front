    ...
    <main>
      <div className="container py-3 py-sm-4 py-lg-5">
        <nav aria-label="breadcrumb">
          <NavLink to="/personal-account/my-ads" className="d-block d-md-none gray-3">
            &#10094; Назад
          </NavLink>
          <ol className="d-none d-md-flex breadcrumb">
            ...
            <li>
              <NavLink to="/personal-account/my-ads">Мои объявления /</NavLink>
            </li>
              ...
              <div className="row">
                <div className="col-md-3 fs-11 title-req mt-4 mt-sm-5 mb-3 m-md-0">
                  <span
                    data-for="deal"
                    data-status={false}
                    style={{ color: valid.isInValidTransactionType ? "#DA1E2A" : "" }}
                  >
                    Сделка*:
                  </span>
                </div>
                  ...
                  <div className="row">
                    <div className="col-md-3 fs-11 title-req mt-4 mt-sm-5 mb-3 m-md-0">
                      <span
                        ...
                        data-status={false}
                        style={{ color: valid.isInValidRentalTypes ? "#DA1E2A" : "" }}
                      >
                        Тип аренды*:
                      </span>
                    </div>
              ...
              <div className="row">
                <div className="col-md-3 fs-11 title-req mt-4 mt-sm-5 mb-3 m-md-0">
                  <span
                    ...
                    data-status={false}
                    style={{ color: valid.isInValidEstateTypeId ? "#DA1E2A" : "" }}
                  >
                    Тип недвижимости*:
                  </span>
                </div>
                    ...
                    <div>
                      <label htmlFor="houseType1">
                        <input
                          ...
                          onClick={() =>
                            setBtnRadio((prevState) => ({ ...prevState, houseType: 0 }))
                          }
                          onChange={(e) => {
                            setData((prevData) => {
                    ...
                    <div>
                      <label htmlFor="houseType2">
                        <input
                          ...
                          onClick={() =>
                            setBtnRadio((prevState) => ({ ...prevState, houseType: 1 }))
                          }
                          onChange={(e) => {
                            setData((prevData) => {
                              return { ...prevData, houseType: e.target.value };
                ...
                <div className="col-md-9 d-flex">
                  <label className="inp-btn me-2">
                    <input
                      ...
                      onClick={() =>
                        setBtnRadio((prevState) => ({ ...prevState, roomType: 0 }))
                      }
                      onChange={(e) => {
                        setData((prevData) => {
                  ...
                  <label className="inp-btn me-2">
                    <input
                      ...
                      onClick={() =>
                        setBtnRadio((prevState) => ({ ...prevState, roomType: 1 }))
                      }
                      onChange={(e) => {
                        setData((prevData) => {
                          return { ...prevData, roomType: e.target.value };
                  ...
                  <label className="inp-btn me-2">
                    <input
                      ...
                      onClick={() =>
                        setBtnRadio((prevState) => ({ ...prevState, roomType: 2 }))
                      }
                      onChange={(e) => {
                        setData((prevData) => {
                          return { ...prevData, roomType: e.target.value };
                  ...
                  <label className="inp-btn me-2">
                    <input
                      ...
                      onClick={() =>
                        setBtnRadio((prevState) => ({ ...prevState, roomType: 3 }))
                      }
                      onChange={(e) => {
                        setData((prevData) => {
                          return { ...prevData, roomType: e.target.value };
                  ...
                  <label className="inp-btn me-2">
                    <input
                      ...
                      onClick={() =>
                        setBtnRadio((prevState) => ({ ...prevState, roomType: 4 }))
                      }
                      onChange={(e) => {
                        setData((prevData) => {
                          return { ...prevData, roomType: e.target.value };
                  ...
                  <label className="inp-btn me-2">
                    <input
                      ...
                      onClick={() =>
                        setBtnRadio((prevState) => ({ ...prevState, roomType: 5 }))
                      }
                      onChange={(e) => {
                        setData((prevData) => {
                          return { ...prevData, roomType: e.target.value };
                  ...
                  <label className="inp-btn me-2">
                    <input
                      ...
                      onClick={() =>
                        setBtnRadio((prevState) => ({ ...prevState, roomType: 6 }))
                      }
                      onChange={(e) => {
                        setData((prevData) => {
                          return { ...prevData, roomType: e.target.value };
                    ...
                    <div>
                      <label>
                        <input
                          ...
                          onClick={() =>
                            setBtnRadio((prevState) => ({ ...prevState, WCType: 0 }))
                          }
                          onChange={(e) => {
                            setData((prevData) => {
                    ...
                    <div>
                      <label>
                        <input
                          ...
                          onClick={() =>
                            setBtnRadio((prevState) => ({ ...prevState, WCType: 1 }))
                          }
                          onChange={(e) => {
                            setData((prevData) => {
                              return { ...prevData, WCType: e.target.value };
                    ...
                    <div>
                      <label>
                        <input
                          ...
                          onClick={() =>
                            setBtnRadio((prevState) => ({ ...prevState, WCType: 2 }))
                          }
                          onChange={(e) => {
                            setData((prevData) => {
                              return { ...prevData, WCType: e.target.value };
                    ...
                    <div>
                      <label>
                        <input
                          ...
                          onClick={() =>
                            setBtnRadio((prevState) => ({ ...prevState, balconyType: 1 }))
                          }
                          onChange={(e) => {
                            setData((prevData) => {
                    ...
                    <div>
                      <label>
                        <input
                          ...
                          onClick={() =>
                            setBtnRadio((prevState) => ({ ...prevState, balconyType: 2 }))
                          }
                          onChange={(e) => {
                            setData((prevData) => {
                              return { ...prevData, balconyType: e.target.value };
                    ...
                    <div>
                      <label>
                        <input
                          ...
                          onClick={() =>
                            setBtnRadio((prevState) => ({ ...prevState, balconyType: 0 }))
                          }
                          onChange={(e) => {
                            setData((prevData) => {
                              return { ...prevData, balconyType: e.target.value };
                    ...
                    <div>
                      <label>
                        <input
                          ...
                          onClick={() =>
                            setBtnRadio((prevState) => ({ ...prevState, layoutType: 0 }))
                          }
                          onChange={(e) => {
                            setData((prevData) => {
                    ...
                    <div>
                      <label>
                        <input
                          ...
                          onClick={() =>
                            setBtnRadio((prevState) => ({ ...prevState, layoutType: 1 }))
                          }
                          onChange={(e) => {
                            setData((prevData) => {
                              return { ...prevData, layoutType: e.target.value };
                    ...
                    <div>
                      <label>
                        <input
                          ...
                          onClick={() =>
                            setBtnRadio((prevState) => ({ ...prevState, layoutType: 2 }))
                          }
                          onChange={(e) => {
                            setData((prevData) => {
                              return { ...prevData, layoutType: e.target.value };
                    ...
                    <div>
                      <label>
                        <input
                          ...
                          onClick={() =>
                            setBtnRadio((prevState) => ({ ...prevState, repairType: 0 }))
                          }
                          onChange={(e) => {
                            setData((prevData) => {
                    ...
                    <div>
                      <label>
                        <input
                          ...
                          onClick={() =>
                            setBtnRadio((prevState) => ({ ...prevState, repairType: 1 }))
                          }
                          onChange={(e) => {
                            setData((prevData) => {
                              return { ...prevData, repairType: e.target.value };
                    ...
                    <div>
                      <label>
                        <input
                          ...
                          onClick={() =>
                            setBtnRadio((prevState) => ({ ...prevState, repairType: 2 }))
                          }
                          onChange={(e) => {
                            setData((prevData) => {
                              return { ...prevData, repairType: e.target.value };
                    ...
                    <div>
                      <label>
                        <input
                          ...
                          onClick={() =>
                            setBtnRadio((prevState) => ({ ...prevState, repairType: 3 }))
                          }
                          onChange={(e) => {
                            setData((prevData) => {
                              return { ...prevData, repairType: e.target.value };
              ...
              <div className="row">
                <div className="col-md-3 fs-11 title-req mb-3 m-md-0">
                  <span
                    data-for="imgs"
                    data-status={false}
                    style={{ color: valid.isInValidImage ? "#DA1E2A" : "" }}
                  >
                    Фото и планировка*:
                  </span>
                </div>
                <div className="col-md-9">
                  ...
                  <div className="fs-08 gray-3 mt-2">
                    ...
                    объектов и рекламные баннеры. JPG, PNG или GIF. Загрузка о 2 штук и
                    более. При загрузке одного фото заменяется главное фото объявления.
                  </div>
                </div>
              </div>
              {/* для мобильных устроийств */}
                  ...
                  <div className="d-flex align-items-baseline flex-wrap">
                    <label className="me-5 my-2">
                      <input
                        ...
                        onClick={() =>
                          setBtnRadio((prevState) => ({ ...prevState, elevatorType: 0 }))
                        }
                        onChange={(e) => {
                          setData((prevData) => {
                    ...
                    <label className="me-5 my-2">
                      <input
                        ...
                        onClick={() =>
                          setBtnRadio((prevState) => ({ ...prevState, elevatorType: 1 }))
                        }
                        onChange={(e) => {
                          setData((prevData) => {
                            return { ...prevData, elevatorType: e.target.value };
                    ...
                    <label className="me-5 my-2">
                      <input
                        ...
                        onClick={() =>
                          setBtnRadio((prevState) => ({ ...prevState, elevatorType: 2 }))
                        }
                        onChange={(e) => {
                          setData((prevData) => {
                            return { ...prevData, elevatorType: e.target.value };
                    ...
                    <label className="me-5 my-2">
                      <input
                        ...
                        onClick={() =>
                          setBtnRadio((prevState) => ({ ...prevState, elevatorType: 3 }))
                        }
                        onChange={(e) => {
                          setData((prevData) => {
                            return { ...prevData, elevatorType: e.target.value };
                  ...
                  <div>
                    <label className="me-5">
                      <input
                        ...
                        onClick={() =>
                          setBtnRadio((prevState) => ({ ...prevState, hasRamp: 1 }))
                        }
                        onChange={(e) => {
                          setData((prevData) => ({
                            ...prevData,
                            hasRamp: e.target.value
                          }));
                        }}
                      />
                  ...
                  <div>
                    <label className="me-5">
                      <input
                        ...
                        onClick={() =>
                          setBtnRadio((prevState) => ({ ...prevState, hasRamp: 0 }))
                        }
                        onChange={(e) => {
                          setData((prevData) => ({
                            ...prevData,
                  ...
                  <div>
                    <label className="me-5">
                      <input
                        ...
                        onClick={() =>
                          setBtnRadio((prevState) => ({ ...prevState, hasGarbage: 1 }))
                        }
                        onChange={(e) => {
                          setData((prevData) => ({
                            ...prevData,
                            hasGarbage: e.target.value
                          }));
                        }}
                      />
                      <span className="fs-11 ms-2">Есть</span>
                  ...
                  <div>
                    <label className="me-5">
                      <input
                        ...
                        onClick={() =>
                          setBtnRadio((prevState) => ({ ...prevState, hasGarbage: 0 }))
                        }
                        onChange={(e) => {
                          setData((prevData) => ({
                            ...prevData,
                    ...
                    <div className="row align-items-center mt-4 mt-sm-5 mb-4">
                      <div className="col-md-3 fs-11 title-req mb-3 m-md-0">
                        <span
                          data-for="price"
                          data-status={false}
                          style={{ color: valid.isInValidPrice ? "#DA1E2A" : "" }}
                        >
                          Цена*:
                        </span>
                      </div>
                    ...
                    <div className="row align-items-center mt-4 mt-sm-5 mb-4">
                      <div className="col-md-3 fs-11 title-req mb-3 m-md-0">
                        <span
                          data-for="hypothec"
                          data-status={false}
                          style={{ color: valid.isInValidHypothec ? "#DA1E2A" : "" }}
                        >
                          Ипотека*:
                        </span>
                      </div>
