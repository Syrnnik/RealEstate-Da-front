...
export default function CardPage() {
  ...
  const imagesAd = []
    .concat(
      ads?.image,
      ads?.images?.map((i) => i?.image)
    )
    .map((i) => (i ? `${sait}${i}` : "/img/nophoto.jpg"));
        ...
        <div className="row">
          <div className="col-lg-8 mb-4 mb-sm-5">
            <div className="position-relative">
              <Swiper
                className="main-slider mb-3 mb-xl-4"
          ...
          <div className="col-lg-10 col-xl-8">
              ...
              <>
                ...
                <div className="row row-cols-2 row-cols-md-3 gx-2 gx-sm-4">
                  ...
                  {ads?.hasConditioner ? (
                    <div className="d-flex align-items-center fs-11 mb-2">
                      <img
                        src="/img/icons/air-conditioner.svg"
                        alt="Кондиционер"
                        className="icon-mini"
                      />
            ...
            {ads && (
              <>
                <h4 className="mt-4 mt-sm-5" ref={mapRef}>
                  На карте
                </h4>
      ...
      >
        <form>
          <div className="text-capitalize mt-4 mb-4">
            <div
              className="fw-bold"
              style={{ color: `${isValidService ? "#DA1E2A" : ""}` }}
            >
          ...
          <div className="mt-4 mb-4">
            ...
            <div>
              <span className="fs-08 gray-3 mt-2">
                Не больше 5 фото, форматы: JPG, JPEG, PNG
              </span>
            </div>
          </div>
          <button
