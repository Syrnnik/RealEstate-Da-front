    ...
    useEffect(() => {
        getTypesEstate()
            ...
            .then(
                (result) =>
                    result &&
                    result.estates.map((item) => ({ title: item.name, value: item.id }))
            )
            .then((estateIds) => {
                setEstateIds(estateIds);
                estateIds?.length &&
                    onSelectHandler(estateIds[0].value, "estateId", setFilters);
            });
    }, []);
                ...
                <form className="form-search mb-4 mb-sm-3">
                    <div className="map-search">
                        ...
                        <button
                            ...
                            onClick={() =>
                                setIsShowMap((prevIsShowMap) => !prevIsShowMap)
                            }
                        >
                            <img src="/img/icons/pin.svg" alt="map pin" />
                            <span className="ms-2 fs-11 fw-5 color-2">
                                Показать на карте
                            </span>
                        </button>
                    </div>
                ...
                <div className="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div className="d-flex align-items-center">
                        <button
                            ...
                            onClick={() =>
                                setIsShowOffcanvasFilters(
                                    (prevIsShowCanvas) => !prevIsShowCanvas
                                )
                            }
                        >
                            <img src="/img/icons/filter.svg" alt="filter" />
                                ...
                                <fieldset className="mb-4">
                                    ...
                                    <label className="ps-2 mb-3">
                                        <input
                                            ...
                                            value="1room"
                                            checked={
                                                filters?.roomTypes?.includes(1) || false
                                            }
                                            onChange={() =>
                                                onMultiCheckboxHandler(
                                                    "roomTypes",
                                    ...
                                    <label className="ps-2 mb-3">
                                        <input
                                            ...
                                            value="2room"
                                            checked={
                                                filters?.roomTypes?.includes(2) || false
                                            }
                                            onChange={() =>
                                                onMultiCheckboxHandler(
                                                    "roomTypes",
                                    ...
                                    <label className="ps-2 mb-3">
                                        <input
                                            ...
                                            value="3room"
                                            checked={
                                                filters?.roomTypes?.includes(3) || false
                                            }
                                            onChange={() =>
                                                onMultiCheckboxHandler(
                                                    "roomTypes",
                                    ...
                                    <label className="ps-2 mb-3">
                                        <input
                                            ...
                                            value="4room"
                                            checked={
                                                filters?.roomTypes?.includes(4) || false
                                            }
                                            onChange={() =>
                                                onMultiCheckboxHandler(
                                                    "roomTypes",
                                    ...
                                    <label className="ps-2 mb-3">
                                        <input
                                            ...
                                            value="5room"
                                            checked={
                                                filters?.roomTypes?.includes(5) || false
                                            }
                                            onChange={() =>
                                                onMultiCheckboxHandler(
                                                    "roomTypes",
                                    ...
                                    <label className="ps-2 mb-3">
                                        <input
                                            ...
                                            value="6room"
                                            checked={
                                                filters?.roomTypes?.includes(6) || false
                                            }
                                            onChange={() =>
                                                onMultiCheckboxHandler(
                                                    "roomTypes",
                                    ...
                                    <label className="ps-2 mb-3">
                                        <input
                                            ...
                                            value="6room"
                                            checked={
                                                filters?.roomTypes?.includes(7) || false
                                            }
                                            onChange={() =>
                                                onMultiCheckboxHandler(
                                                    "roomTypes",
                                    ...
                                    <label className="ps-2 mb-3">
                                        <input
                                            ...
                                            value="studio"
                                            checked={
                                                filters?.roomTypes?.includes(0) || false
                                            }
                                            onChange={() =>
                                                onMultiCheckboxHandler(
                                                    "roomTypes",
                                    ...
                                    <fieldset className="mb-4">
                                        ...
                                        <label className="ps-2 mb-3">
                                            <input
                                                ...
                                                value="lease 1"
                                                checked={
                                                    filters?.rentalTypes?.includes(0) ||
                                                    false
                                                }
                                                onChange={() =>
                                                    onMultiCheckboxHandler(
                                        ...
                                        <label className="ps-2 mb-3">
                                            <input
                                                ...
                                                value="lease 2"
                                                checked={
                                                    filters?.rentalTypes?.includes(3) ||
                                                    false
                                                }
                                                onChange={() =>
                                                    onMultiCheckboxHandler(
                                        ...
                                        <label className="ps-2 mb-3">
                                            <input
                                                ...
                                                value="lease 3"
                                                checked={
                                                    filters?.rentalTypes?.includes(1) ||
                                                    false
                                                }
                                                onChange={() =>
                                                    onMultiCheckboxHandler(
                                ...
                                <fieldset className="mb-4">
                                    ...
                                    <label className="ps-2 mb-3">
                                        <input
                                            ...
                                            value="no repair"
                                            checked={
                                                filters?.repairTypes?.includes(3) || false
                                            }
                                            onChange={() =>
                                                onMultiCheckboxHandler(
                                                    "repairTypes",
                                    ...
                                    <label className="ps-2 mb-3">
                                        <input
                                            ...
                                            value="repair 1"
                                            checked={
                                                filters?.repairTypes?.includes(0) || false
                                            }
                                            onChange={() =>
                                                onMultiCheckboxHandler(
                                                    "repairTypes",
                                    ...
                                    <label className="ps-2 mb-3">
                                        <input
                                            ...
                                            value="repair 2"
                                            checked={
                                                filters?.repairTypes?.includes(1) || false
                                            }
                                            onChange={() =>
                                                onMultiCheckboxHandler(
                                                    "repairTypes",
                                    ...
                                    <label className="ps-2 mb-3">
                                        <input
                                            ...
                                            value="repair 3"
                                            checked={
                                                filters?.repairTypes?.includes(2) || false
                                            }
                                            onChange={() =>
                                                onMultiCheckboxHandler(
                                                    "repairTypes",
                                ...
                                <fieldset className="mb-4">
                                    ...
                                    <label className="ps-2 mb-3">
                                        <input
                                            ...
                                            value="locationType"
                                            checked={
                                                filters?.locationType?.includes(0) ||
                                                false
                                            }
                                            onChange={() =>
                                                onMultiCheckboxHandler(
                                    ...
                                    <label className="ps-2 mb-3">
                                        <input
                                            ...
                                            value="locationType"
                                            checked={
                                                filters?.locationType?.includes(1) ||
                                                false
                                            }
                                            onChange={() =>
                                                onMultiCheckboxHandler(
                                ...
                                <fieldset className="mb-4">
                                    ...
                                    <label className="ps-2 mb-3">
                                        <input
                                            ...
                                            value="hasSecurity"
                                            checked={
                                                filters?.hasSecurity?.includes(2) || false
                                            }
                                            onChange={() =>
                                                onMultiCheckboxHandler(
                                                    "hasSecurity",
                                    ...
                                    <label className="ps-2 mb-3">
                                        <input
                                            ...
                                            value="hasSecurity"
                                            checked={
                                                filters?.hasSecurity?.includes(1) || false
                                            }
                                            onChange={() =>
                                                onMultiCheckboxHandler(
                                                    "hasSecurity",
                                ...
                                <fieldset className="mb-4">
                                    ...
                                    <label className="ps-2 mb-3">
                                        <input
                                            ...
                                            value="buildingType"
                                            checked={
                                                filters?.buildingType?.includes(0) ||
                                                false
                                            }
                                            onChange={() =>
                                                onMultiCheckboxHandler(
                                    ...
                                    <label className="ps-2 mb-3">
                                        <input
                                            ...
                                            value="buildingType"
                                            checked={
                                                filters?.buildingType?.includes(1) ||
                                                false
                                            }
                                            onChange={() =>
                                                onMultiCheckboxHandler(
                                    ...
                                    <label className="ps-2 mb-3">
                                        <input
                                            ...
                                            value="buildingType"
                                            checked={
                                                filters?.buildingType?.includes(2) ||
                                                false
                                            }
                                            onChange={() =>
                                                onMultiCheckboxHandler(
                                    ...
                                    <label className="ps-2 mb-3">
                                        <input
                                            ...
                                            value="buildingType"
                                            checked={
                                                filters?.buildingType?.includes(3) ||
                                                false
                                            }
                                            onChange={() =>
                                                onMultiCheckboxHandler(
                                    ...
                                    <label className="ps-2 mb-3">
                                        <input
                                            ...
                                            value="buildingType"
                                            checked={
                                                filters?.buildingType?.includes(4) ||
                                                false
                                            }
                                            onChange={() =>
                                                onMultiCheckboxHandler(
                                ...
                                <fieldset className="mb-4">
                                    ...
                                    <label className="ps-2 mb-3">
                                        <input
                                            ...
                                            checked={
                                                filters?.houseBuildingType?.includes(0) ||
                                                false
                                            }
                                            onChange={() =>
                                                onMultiCheckboxHandler(
                                    ...
                                    <label className="ps-2 mb-3">
                                        <input
                                            ...
                                            value="houseBuildingType"
                                            checked={
                                                filters?.houseBuildingType?.includes(1) ||
                                                false
                                            }
                                            onChange={() =>
                                                onMultiCheckboxHandler(
                                    ...
                                    <label className="ps-2 mb-3">
                                        <input
                                            ...
                                            value="houseBuildingType"
                                            checked={
                                                filters?.houseBuildingType?.includes(2) ||
                                                false
                                            }
                                            onChange={() =>
                                                onMultiCheckboxHandler(
                                    ...
                                    <label className="ps-2 mb-3">
                                        <input
                                            ...
                                            value="houseBuildingType"
                                            checked={
                                                filters?.houseBuildingType?.includes(3) ||
                                                false
                                            }
                                            onChange={() =>
                                                onMultiCheckboxHandler(
                                    ...
                                    <label className="ps-2 mb-3">
                                        <input
                                            ...
                                            value="houseBuildingType"
                                            checked={
                                                filters?.houseBuildingType?.includes(4) ||
                                                false
                                            }
                                            onChange={() =>
                                                onMultiCheckboxHandler(
                                    ...
                                    <label className="ps-2 mb-3">
                                        <input
                                            ...
                                            value="houseBuildingType"
                                            checked={
                                                filters?.houseBuildingType?.includes(5) ||
                                                false
                                            }
                                            onChange={() =>
                                                onMultiCheckboxHandler(
                                    ...
                                    <label className="ps-2 mb-3">
                                        <input
                                            ...
                                            value="houseBuildingType"
                                            checked={
                                                filters?.houseBuildingType?.includes(6) ||
                                                false
                                            }
                                            onChange={() =>
                                                onMultiCheckboxHandler(
                                    ...
                                    <label className="ps-2 mb-3">
                                        <input
                                            ...
                                            value="houseBuildingType"
                                            checked={
                                                filters?.houseBuildingType?.includes(7) ||
                                                false
                                            }
                                            onChange={() =>
                                                onMultiCheckboxHandler(
                                    ...
                                    <label className="ps-2 mb-3">
                                        <input
                                            ...
                                            value="houseBuildingType"
                                            checked={
                                                filters?.houseBuildingType?.includes(8) ||
                                                false
                                            }
                                            onChange={() =>
                                                onMultiCheckboxHandler(
                                    ...
                                    <label className="ps-2 mb-3">
                                        <input
                                            ...
                                            value="houseBuildingType"
                                            checked={
                                                filters?.houseBuildingType?.includes(9) ||
                                                false
                                            }
                                            onChange={() =>
                                                onMultiCheckboxHandler(
                                    ...
                                    <label className="ps-2 mb-3">
                                        <input
                                            ...
                                            value="houseBuildingType"
                                            checked={
                                                filters?.houseBuildingType?.includes(
                                                    10
                                                ) || false
                                            }
                                            onChange={() =>
                        ...
                        >
                            {catalogData?.isLoaded ? (
                                catalogData?.catalog?.length ? (
                                    catalogData?.catalog?.map((catalogItem) => (
                                        <div key={catalogItem.id}>
                                            <Card
                                                ...
                                                transactionType={
                                                    catalogItem.transactionType
                                                }
                                                residentalComplex={
                                                    catalogItem.residentalComplex
                                                }
                                                residentalComplexForUser={
                                                    catalogItem.residentalComplexForUser
                                                }
                                                ...
                                                commissionForUser={
                                                    catalogItem.commissionForUser
                                                }
                                                prepaymentTypeForUser={
                                                    catalogItem.prepaymentTypeForUser
                                                }
                                                rentalTypeForUser={
                                                    catalogItem.rentalTypeForUser
                                                }
                                                wishlistStatus={
                                                    catalogItem.wishlistStatus
                                                }
                                                userAvatar={catalogItem.user?.avatar}
                                                routeName={routeName}
                                                estateName={catalogItem?.estate?.name}
                                                buildingTypeForUser={
                                                    catalogItem?.buildingTypeForUser
                                                }
                                                realEstateTypeForUser={
                                                    catalogItem?.estate
                                                        ?.realEstateTypeForUser
                                                }
                                    ...
                                    <h6 className="m-auto p-5 text-center">
                                        Объявлений нет
                                    </h6>
                                )
                            ) : (
