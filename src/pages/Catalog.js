...
const Catalog = ({ routeName }) => {
  ...
  useEffect(() => {
    getTypesEstate()
      ...
      .then(
        (result) =>
          result && result.estates.map((item) => ({ title: item.name, value: item.id }))
      )
      .then((estateIds) => {
  ...
  useEffect(() => {
    ...
    selectedCity &&
      getDistricts(selectedCity)
        .then(
          (result) =>
            result && result.map((item) => ({ title: item.name, value: item.id }))
        )
      ...
      <section className="sec-6 container pb-5">
        ...
        <form className="form-search mb-3 mb-sm-3">
            ...
            <button
              ...
              onClick={() =>
                setIsShowOffcanvasFilters(
                  (prevIsShowOffcanvasFilters) => !prevIsShowOffcanvasFilters
                )
              }
            >
          ...
          <MultiCheckboxSelect
            ...
            options={districts}
            callback={({ value }) =>
              onMultiCheckboxHandler("districts", value, setFilters)
            }
            align="right"
          />
          <AddressSuggestions
        ...
        <div className="d-flex flex-column justify-content-between align-items-start gap-2 mb-4">
          ...
          <div className="d-flex align-items-center">
            <button
              ...
              onClick={() =>
                setIsShowOffcanvasFilters((prevIsShowCanvas) => !prevIsShowCanvas)
              }
            >
              <img src="/img/icons/filter.svg" alt="filter" />
              <span className="ms-2 fs-11 fw-5 color-1">Фильтры</span>
            ...
            {+searchParams.get("typesEstate") === 1 && (
              <form className="shad-box p-4 mb-4">
                <fieldset className="mb-4">
                  <legend className="title-font fs-12 fw-6 mb-3">
                    Количество комнат:
                  </legend>
                  ...
                  <fieldset className="mb-4">
                    ...
                    <label className="ps-2 mb-3">
                      <input
                        ...
                        onChange={() =>
                          onMultiCheckboxHandler("rentalTypes", 0, setFilters)
                        }
                      />
                    ...
                    <label className="ps-2 mb-3">
                      <input
                        ...
                        onChange={() =>
                          onMultiCheckboxHandler("rentalTypes", 3, setFilters)
                        }
                      />
                    ...
                    <label className="ps-2 mb-3">
                      <input
                        ...
                        onChange={() =>
                          onMultiCheckboxHandler("rentalTypes", 1, setFilters)
                        }
                      />
                ...
                <fieldset className="mb-4">
                  ...
                  <label className="ps-2 mb-3">
                    <input
                      ...
                      onChange={() =>
                        onMultiCheckboxHandler("repairTypes", 3, setFilters)
                      }
                    />
                  ...
                  <label className="ps-2 mb-3">
                    <input
                      ...
                      onChange={() =>
                        onMultiCheckboxHandler("repairTypes", 0, setFilters)
                      }
                    />
                  ...
                  <label className="ps-2 mb-3">
                    <input
                      ...
                      onChange={() =>
                        onMultiCheckboxHandler("repairTypes", 1, setFilters)
                      }
                    />
                  ...
                  <label className="ps-2 mb-3">
                    <input
                      ...
                      onChange={() =>
                        onMultiCheckboxHandler("repairTypes", 2, setFilters)
                      }
                    />
                ...
                <button
                  type="button"
                  className="btn btn-1 w-100 fs-15"
                  data-bs-toggle="modal"
                  data-bs-target="#desktopFilters"
                >
                  Еще фильтры
                </button>
                <button
                  ...
                  className="color-1 fs-11 fw-5 mx-auto mt-2"
                >
                  Очистить фильтр
                </button>
              </form>
                ...
                <fieldset className="mb-4">
                  ...
                  <label className="ps-2 mb-3">
                    <input
                      ...
                      onChange={() =>
                        onMultiCheckboxHandler("locationType", 0, setFilters)
                      }
                    />
                  ...
                  <label className="ps-2 mb-3">
                    <input
                      ...
                      onChange={() =>
                        onMultiCheckboxHandler("locationType", 1, setFilters)
                      }
                    />
                ...
                <fieldset className="mb-4">
                  ...
                  <div className="d-flex align-items-baseline">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        onInputHandler(e, "startTotalArea", true, setFilters)
                      }
                    />
                    <div className="fs-11 me-2">До</div>
                    <input
                      ...
                      onChange={(e) =>
                        onInputHandler(e, "endTotalArea", true, setFilters)
                      }
                    />
                  </div>
                </fieldset>
                ...
                <fieldset className="mb-4">
                  ...
                  <div className="d-flex align-items-baseline">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        onInputHandler(e, "yearOfConstruction", true, setFilters)
                      }
                    />
                  </div>
                </fieldset>
                ...
                <fieldset className="mb-4">
                  ...
                  <div className="d-flex align-items-baseline">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        onInputHandler(e, "startCityDistance", true, setFilters)
                      }
                    />
                    <div className="fs-11 me-2">До</div>
                    <input
                      ...
                      onChange={(e) =>
                        onInputHandler(e, "endCityDistance", true, setFilters)
                      }
                    />
                  </div>
                </fieldset>
                ...
                <fieldset className="mb-4">
                  ...
                  <label className="ps-2 mb-3">
                    <input
                      ...
                      onChange={() =>
                        onMultiCheckboxHandler("buildingType", 0, setFilters)
                      }
                    />
                  ...
                  <label className="ps-2 mb-3">
                    <input
                      ...
                      onChange={() =>
                        onMultiCheckboxHandler("buildingType", 1, setFilters)
                      }
                    />
                  ...
                  <label className="ps-2 mb-3">
                    <input
                      ...
                      onChange={() =>
                        onMultiCheckboxHandler("buildingType", 2, setFilters)
                      }
                    />
                  ...
                  <label className="ps-2 mb-3">
                    <input
                      ...
                      onChange={() =>
                        onMultiCheckboxHandler("buildingType", 3, setFilters)
                      }
                    />
                  ...
                  <label className="ps-2 mb-3">
                    <input
                      ...
                      onChange={() =>
                        onMultiCheckboxHandler("buildingType", 4, setFilters)
                      }
                    />
                ...
                <fieldset className="mb-4">
                  ...
                  <label className="ps-2 mb-3">
                    <input
                      ...
                      onChange={() =>
                        onMultiCheckboxHandler("houseBuildingType", 0, setFilters)
                      }
                    />
                  ...
                  <label className="ps-2 mb-3">
                    <input
                      ...
                      onChange={() =>
                        onMultiCheckboxHandler("houseBuildingType", 1, setFilters)
                      }
                    />
                  ...
                  <label className="ps-2 mb-3">
                    <input
                      ...
                      onChange={() =>
                        onMultiCheckboxHandler("houseBuildingType", 2, setFilters)
                      }
                    />
                  ...
                  <label className="ps-2 mb-3">
                    <input
                      ...
                      onChange={() =>
                        onMultiCheckboxHandler("houseBuildingType", 3, setFilters)
                      }
                    />
                  ...
                  <label className="ps-2 mb-3">
                    <input
                      ...
                      onChange={() =>
                        onMultiCheckboxHandler("houseBuildingType", 4, setFilters)
                      }
                    />
                  ...
                  <label className="ps-2 mb-3">
                    <input
                      ...
                      onChange={() =>
                        onMultiCheckboxHandler("houseBuildingType", 5, setFilters)
                      }
                    />
                  ...
                  <label className="ps-2 mb-3">
                    <input
                      ...
                      onChange={() =>
                        onMultiCheckboxHandler("houseBuildingType", 6, setFilters)
                      }
                    />
                  ...
                  <label className="ps-2 mb-3">
                    <input
                      ...
                      onChange={() =>
                        onMultiCheckboxHandler("houseBuildingType", 7, setFilters)
                      }
                    />
                  ...
                  <label className="ps-2 mb-3">
                    <input
                      ...
                      onChange={() =>
                        onMultiCheckboxHandler("houseBuildingType", 8, setFilters)
                      }
                    />
                  ...
                  <label className="ps-2 mb-3">
                    <input
                      ...
                      onChange={() =>
                        onMultiCheckboxHandler("houseBuildingType", 9, setFilters)
                      }
                    />
                  ...
                  <label className="ps-2 mb-3">
                    <input
                      ...
                      onChange={() =>
                        onMultiCheckboxHandler("houseBuildingType", 10, setFilters)
                      }
                    />
                  ...
                  <label className="ps-2 mb-3">
                    <input
                      ...
                      onChange={() =>
                        onMultiCheckboxHandler("houseBuildingType", 11, setFilters)
                      }
                    />
              ...
              {catalogData?.isLoaded ? (
                catalogData?.catalog?.length ? (
                  catalogData?.catalog?.map((catalogItem) => (
                    <div key={catalogItem.id} className="d-grid col-6">
                      <Card
                        type={view}
