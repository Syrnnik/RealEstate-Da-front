...
export default function Services() {
    ...
    useEffect(() => {
        if (city !== null) {
            getServicesUsers(axiosPrivate, delayPayload, city).then((res) =>
                setUsers({
                    isLoading: true,
                    data: res?.body?.data,
                    meta: res?.body?.meta
        ...
        <main>
            <nav aria-label="breadcrumb">
                <div className="container py-3 py-sm-4 py-lg-5">
                    <NavLink to="/services" className="d-block d-md-none gray-3">
                        &#10094; Назад
                    </NavLink>
                </div>
            </nav>
                        ...
                        <form className="service-leftMenu">
                            ...
                            <div className="p-3 p-xxl-4">
                                <fieldset className="mb-4">
                                    <legend className="title-font text-left fs-12 fw-6 mb-3">
                                        Поиск по ФИО:
                                    </legend>
                    ...
                    <div className="col-xl-8 col-xxl-9">
                        <div className="d-flex justify-content-between mb-3 mb-xl-2">
                            <button
                                ...
                                data-bs-target="#offcanvasServiceFilter"
